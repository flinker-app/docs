...
After setting up the tab, the settings window will automatically appear. You can edit the file links now or return to this step later to adjust them as needed.
